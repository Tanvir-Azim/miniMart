   ...
   `
    ...
    //lg:place-items-center  
     ...
     return (
      ...
      <div className=' w-[77%] h-[95vh]  md:h-[150vh] sm:h-[150vh] xs:h-[300vh] lg:w-[85%] grid grid-cols-4 grid-rows-2 gap-4 m-auto mt-10  sm:mt-[20px] md:grid-cols-2 md:grid-rows-[170px 170px  ] sm:grid-cols-2 sm:grid-rows-[170px 170px 170px 170px] xs:grid-cols-1 xs:grid-rows-[170px 170px 170px] lg:gap-20 '>
